...
const IndustryPage = ({setTitle ,setbutton1 ,setbutton2 ,setbuttonname1, setbuttonname2 ,setp1 ,setp2}) => {
    useEffect(() => {
  ...
  return (
    <div className='sponsPage'>
        <div className="sponsheading">INDUSTRY</div>
